...
var DataRouterContext = Q(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = Q(null);
DataRouterStateContext.displayName = "DataRouterState";
var RSCRouterContext = Q(false);
function useIsRSCRouterContext() {
  return x2(RSCRouterContext);
}
var ViewTransitionContext = Q({
  isTransitioning: false
});
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = Q(
  /* @__PURE__ */ new Map()
);
FetchersContext.displayName = "Fetchers";
var AwaitContext = Q(null);
AwaitContext.displayName = "Await";
var AwaitContextProvider = (props) => _(AwaitContext.Provider, props);
var NavigationContext = Q(
  null
);
NavigationContext.displayName = "Navigation";
var LocationContext = Q(
  null
);
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator } = x2(NavigationContext);
...
function useOutlet(context) {
  ...
  return T(
    () => outlet && _(OutletContext.Provider, { value: context }, outlet),
    [outlet, context]
  );
}
function useParams() {
...
function useRoutesImpl(routes, locationArg, dataRouterState, onError, future) {
  ...
  let { navigator } = x2(NavigationContext);
...
function DefaultErrorComponent() {
  ...
  if (ENABLE_DEV_WARNINGS) {
    ...
    devInfo = _(k, null, _("p", null, "💿 Hey developer 👋"), _("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", _("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", _("code", { style: codeStyles }, "errorElement"), " prop on your route."));
  }
  return _(k, null, _("h2", null, "Unexpected Application Error!"), _("h3", { style: { fontStyle: "italic" } }, message), stack ? _("pre", { style: preStyles }, stack) : null, devInfo);
}
...
var RenderErrorBoundary = class extends x {
  ...
  render() {
    ...
    let result = error !== void 0 ? _(RouteContext.Provider, { value: this.props.routeContext }, _(
    ...
    if (this.context) {
      return _(RSCErrorHandler, { error }, result);
    }
    return result;
  }
};
...
function RenderedRoute({ routeContext, match, children }) {
  ...
  return _(RouteContext.Provider, { value: routeContext }, children);
}
function _renderMatches(matches, parentMatches = [], dataRouterState = null, onErrorHandler = null, future = null) {
  ...
  return renderedMatches.reduceRight(
    (outlet, match, index) => {
      ...
      return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? _(
        RenderErrorBoundary,
        {
          location: dataRouterState.location,
...
function RouterProvider({
  ...
  let [_state, setStateImpl] = d(router2.state);
  ...
  _2(() => router2.subscribe(setState), [router2, setState]);
  y(() => {
  ...
  return _(k, null, _(DataRouterContext.Provider, { value: dataRouterContext }, _(DataRouterStateContext.Provider, { value: state }, _(FetchersContext.Provider, { value: fetcherData.current }, _(ViewTransitionContext.Provider, { value: vtContext }, _(
    Router,
    {
      basename,
      location: state.location,
...
function Router({
  ...
  return _(NavigationContext.Provider, { value: navigationContext }, _(LocationContext.Provider, { children, value: locationContext }));
}
function Routes({
  children,
  location: location2
...
function Await({
  ...
  let dataRouterContext = x2(DataRouterContext);
  let dataRouterStateContext = x2(DataRouterStateContext);
  let onError = q(
    (error, errorInfo) => {
...
var AwaitErrorBoundary = class extends x {
  ...
  render() {
    ...
    if (status === 2) {
      return _(AwaitContext.Provider, { value: promise, children: errorElement });
    }
    if (status === 1) {
      return _(AwaitContext.Provider, { value: promise, children });
    }
    throw promise;
  }
};
...
function WithComponentProps({
  ...
  return _n(children, props);
}
function withComponentProps(Component4) {
  return function WithComponentProps2() {
    const props = useRouteComponentProps();
    return _(Component4, props);
  };
}
...
function withHydrateFallbackProps(HydrateFallback) {
  return function WithHydrateFallbackProps2() {
    const props = useHydrateFallbackProps();
    return _(HydrateFallback, props);
  };
}
...
function StreamTransfer({
  ...
  if (done) {
    ...
    return _(k, null, scriptTag, _(P, null, _(
      StreamTransfer,
      {
        context,
...
function RemixRootDefaultHydrateFallback() {
  return _(BoundaryShell, { title: "Loading...", renderScripts: true }, ENABLE_DEV_WARNINGS ? _(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => _(RemixRootDefaultErrorBoundary, { error: useRouteError() }) : void 0;
  if (route.id === "root" && routeModule.Layout) {
    return {
      ...Component4 ? {
        element: _(routeModule.Layout, null, _(Component4, null))
      } : { Component: Component4 },
      ...ErrorBoundary ? {
        errorElement: _(routeModule.Layout, null, _(ErrorBoundary, null))
      } : { ErrorBoundary },
      ...HydrateFallback ? {
        hydrateFallbackElement: _(routeModule.Layout, null, _(HydrateFallback, null))
      } : { HydrateFallback }
    };
  }
  ...
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    if (routeModule) {
      ...
      if (!route.hasClientLoader) {
        dataRoute.loader = (_3, singleFetch) => prefetchStylesAndCallHandler(() => {
          return fetchServerLoader(singleFetch);
        });
      }
      if (!route.hasClientAction) {
        dataRoute.action = (_3, singleFetch) => prefetchStylesAndCallHandler(() => {
          if (isSpaMode) {
            throw noActionDefinedError("clientAction", route.id);
          }
          return fetchServerAction(singleFetch);
...
function Links({ nonce }) {
  ...
  return _(k, null, typeof criticalCss === "string" ? _(
    "style",
    {
      ...{ [CRITICAL_CSS_DATA_ATTRIBUTE]: "" },
      dangerouslySetInnerHTML: { __html: criticalCss }
    }
  ) : null, typeof criticalCss === "object" ? _(
    "link",
    {
      ...{ [CRITICAL_CSS_DATA_ATTRIBUTE]: "" },
      rel: "stylesheet",
    ...
    ({ key, link }) => isPageLinkDescriptor(link) ? _(PrefetchPageLinks, { key, nonce, ...link }) : _("link", { key, nonce, ...link })
  ));
}
function PrefetchPageLinks({ page, ...linkProps }) {
  ...
  return _(PrefetchPageLinksImpl, { page, matches, ...linkProps });
}
...
function PrefetchPageLinksImpl({
  ...
  return _(k, null, dataHrefs.map((href2) => _("link", { key: href2, rel: "prefetch", as: "fetch", href: href2, ...linkProps })), moduleHrefs.map((href2) => _("link", { key: href2, rel: "modulepreload", href: href2, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => (
    // these don't spread `linkProps` because they are full link descriptors
    // already with their own props
    _("link", { key, nonce: linkProps.nonce, ...link })
  )));
}
function Meta() {
  ...
  return _(k, null, meta.flat().map((metaProps) => {
    if (!metaProps) {
      return null;
    }
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return _(Comp, { key: JSON.stringify(rest), ...rest });
    }
    if ("title" in metaProps) {
      return _("title", { key: "title" }, String(metaProps.title));
    }
    ...
    if ("charSet" in metaProps && metaProps.charSet != null) {
      return typeof metaProps.charSet === "string" ? _("meta", { key: "charSet", charSet: metaProps.charSet }) : null;
    }
    ...
    return _("meta", { key: JSON.stringify(metaProps), ...metaProps });
  }));
}
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  return isHydrated || isRSCRouterContext ? null : _(k, null, typeof manifest.sri === "object" ? _(
    "script",
    {
      ...scriptProps,
      "rr-importmap": "",
...
function RemixRootDefaultErrorBoundary({
  ...
  if (isRouteErrorResponse(error)) {
    return _(BoundaryShell, { title: "Unhandled Thrown Response!" }, _("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), ENABLE_DEV_WARNINGS ? heyDeveloper : null);
  }
  let errorInstance;
  ...
  return _(
    ...
    _("h1", { style: { fontSize: "24px" } }, "Application Error"),
    _(
      "pre",
      {
        style: {
...
function BoundaryShell({
  ...
  return _("html", { lang: "en" }, _("head", null, _("meta", { charSet: "utf-8" }), _(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), _("title", null, title)), _("body", null, _("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children, renderScripts ? _(Scripts, null) : null)));
}
...
var Link = D(
  function LinkWithRef({
    ...
    let { basename, unstable_useTransitions } = x2(NavigationContext);
    ...
    return shouldPrefetch && !isAbsolute ? _(k, null, link, _(PrefetchPageLinks, { page: href2 })) : link;
  }
);
...
var NavLink = D(
  function NavLinkWithRef({
    ...
    let { navigator, basename } = x2(NavigationContext);
...
var Form = D(
  ({
    ...
    let { unstable_useTransitions } = x2(NavigationContext);
...
function useFetcher({
  ...
  let FetcherForm = T(() => {
    let FetcherForm2 = D(
      (props, ref) => {
        return _(Form, { ...props, navigate: false, fetcherKey, ref });
      }
    );
...
function StaticRouterProvider({
  ...
  return _(k, null, _(DataRouterContext.Provider, { value: dataRouterContext }, _(DataRouterStateContext.Provider, { value: state }, _(FetchersContext.Provider, { value: fetchersContext }, _(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, _(
    Router,
    {
...
function ServerRouter({
  ...
  return _(k, null, _(
    ...
    _(RemixErrorBoundary, { location: router2.state.location }, _(
  ...
  ), context.serverHandoffStream ? _(P, null, _(
    StreamTransfer,
    {
      context,
      identifier: 0,
...
function createRoutesStub(routes, _context) {
  return function RoutesTestStub({
    ...
    return _(FrameworkContext.Provider, { value: frameworkContextRef.current }, _(RouterProvider, { router: routerRef.current }));
  };
}
...
var RSCRouterGlobalErrorBoundary = class extends Rn.Component {
  constructor(props) {
    super(props);
...
function ErrorWrapper({
  ...
  return Rn.createElement("html", { lang: "en" }, Rn.createElement("head", null, Rn.createElement("meta", { charSet: "utf-8" }), Rn.createElement(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), Rn.createElement("title", null, title)), Rn.createElement("body", null, Rn.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children)));
}
function RSCDefaultRootErrorBoundaryImpl({
  ...
  console.error(error);
  let heyDeveloper = Rn.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
  ...
  if (isRouteErrorResponse(error)) {
    return Rn.createElement(
      ...
      Rn.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText),
  ...
  return Rn.createElement(ErrorWrapper, { renderAppShell, title: "Application Error!" }, Rn.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), Rn.createElement(
    "pre",
    {
      style: {
        padding: "2rem",
...
function RSCStaticRouter({ getPayload }) {
  ...
  return _(RSCRouterContext.Provider, { value: true }, _(RSCRouterGlobalErrorBoundary, { location: payload.location }, _(FrameworkContext.Provider, { value: frameworkContext }, _(
    StaticRouterProvider,
    {
      context,
      router: router2,
...
function RouterProvider2(props) {
  return _(RouterProvider, { flushSync: En, ...props });
}
var ssrInfo = null;
var router = null;
...
function HydratedRouter(props) {
  ...
  let [criticalCss, setCriticalCss] = d(
  ...
  let [location2, setLocation] = d(router.state.location);
  _2(() => {
  ...
  return (
    ...
    _(k, null, _(
      ...
      _(RemixErrorBoundary, { location: location2 }, _(
        RouterProvider2,
        {
          router,
